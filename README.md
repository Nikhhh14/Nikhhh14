...
<p>
  <img src="https://readme-typing-svg.herokuapp.com/?lines=Java+Full+Stack+Developer;Spring+Boot+%26+React;Building+Scalable+Apps;Passionate+About+Clean+Code&font=Fira%20Code&pause=1000&center=true&width=600&height=65" alt="Typing SVG" />
</p>
...
```mermaid
graph TD
    A[🚀 Spring Boot REST APIs] --> B[📊 Microservices]
    B --> C[🐳 Docker & Kubernetes]
    C --> D[⚛️ Advanced React]
    D --> E[☁️ AWS Cloud Services]
    A --> F[🔐 Spring Security]
